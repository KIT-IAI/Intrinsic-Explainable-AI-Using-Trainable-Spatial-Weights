...
def download_hres_grib_files(output_dir, years, months, resolution):
    days = lambda year, month: np.arange(
    ...
    for year, month, day in dates:
        params = [
            ...
            '10u', '10v',  # u, v component of wind at 100m
            '100u', '100v',  # u, v component of wind at 100m
        ...
        request = {
            ...
            'stream': 'oper',
            'time': '00/12',
            'type': 'fc'  # fc=forecast, an=analysis
        }
        target_file = f'{year}_{month:02}_{day:02}.grib2'
